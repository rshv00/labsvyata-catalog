...
export const programs: Program[] = [
  {
    slug: "program-kindergarten-1h",
    name_ua: "Програми для садочків і молодших шкіл",
    short_ua: "1 година активних ігор, дискотека з бульбашками та подарунки на вибір.",
    description_ua:
      "Програма для групи дітей у садочку або молодшій школі: активні ігри з яскравим реквізитом, музичний супровід та фінальна дискотека з мильними бульбашками. Додатково — фігурки з повітряних кульок або флеш-тату (на вибір).",
    recommended_ages_ua: "3-9 років",
    duration_minutes: 60,
    price_uah_from: 3500,
    tags_ua: ["Садочок", "Школа", "1 година", "Групові свята"],
    included_ua: [
      "2 ведучих",
      "Музичний супровід",
    ...
    pricing_notes_ua: [
      "Новорічні свята та випускні рахуються окремо.",
      "Трансфер за межі м. Боярка оплачується окремо.",
    ],
    pricing_tiers: [
      { label_ua: "до 15 дітей", price_uah: 3500 },
      { label_ua: "до 25 дітей", price_uah: 4000 },
      { label_ua: "понад 25 дітей", price_uah: 4700, note_ua: "3 ведучих" },
    ],
    hero_image: { src: placeholder, alt: "Програма для садочків і молодших шкіл" },
    images: [{ src: placeholder, alt: "Фото програми для садочків і молодших шкіл" }],
    is_featured: true,
  },
  {
    slug: "pirate-quest",
